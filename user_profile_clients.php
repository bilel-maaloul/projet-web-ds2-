...
<body class="bg-dark">
    ...
    <header class="header" >
        ...
        <nav class="navbar">
			...
			<a href="user_profile.php"  style=" background: rgba(0, 255, 64, 0.616);">back</a>
			<a href="delete.php"  style=" background: #f00;  margin-left: 2rem;">delete</a>
...
$nom=$_GET['name'];
setcookie('delete',$nom,time()+3600);
            		...
            		<div  class="col-xl-12 bg-white rounded-right black text-white ">
                    	...
                    	<hr class="green">
                   		...
                   		<div class="row">
                        	...
                        	<div class="col-sm-6" style="font-size: 1.7rem;"  >
						  ...
						  echo	'<a   href="user_profile.php?name='.$data["user_name"].' " >'. $data["user_name"].'<br></a>';
